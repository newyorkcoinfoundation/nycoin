...
"(default: %s)"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Fees (in NYC/Kb) smaller than this are considered zero fee for transaction "
"creation (default: %s)"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "RPC SSL options: (see the Newyorkcoin Wiki for SSL setup instructions)"),
