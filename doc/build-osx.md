...
====================================
This guide will show you how to build Newyorkcoind(headless client) for OS X.
...
After exiting, you'll get a warning that the install is keg-only, which means it wasn't symlinked to `/usr/local`.  You don't need it to link it to build Newyorkcoin, but if you want to, here's how:
...
Once dependencies are compiled, see release-process.md for how the Newyorkcoin-Qt.app
