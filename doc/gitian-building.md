...
Clone the git repositories for Newyorkcoin and Gitian and then checkout the Newyorkcoin version that you want to build.
...
To build Newyorkcoin (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/Newyorkcoin-project/Newyorkcoin
...
For example:
```bash
URL=https://github.com/user/Newyorkcoin.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/Newyorkcoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/Newyorkcoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/Newyorkcoin-build.assert
```
...
[Newyorkcoin/gitian.sigs](https://github.com/Newyorkcoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
request. 
